	...
	<div class="row">
		...
		<div class="col-md-9">
				...
				<thead>
					<tr>
			                            <th><?php echo $this->Paginator->sort('id'); ?></th>
            			                            ...
            			                            <th><?php echo $this->Paginator->sort('thumbnail_picture'); ?></th>
			...
			<?php echo $this->Html->link($profile['User']['id'], array('controller' => 'users', 'action' => 'view', $profile['User']['id'])); ?>
						...
						<td><?php echo h($profile['Profile']['full_name']); ?>&nbsp;</td>
						<td><?php echo h($profile['Profile']['picture']); ?>&nbsp;</td>
						<td><?php echo h($profile['Profile']['thumbnail_picture']); ?>&nbsp;</td>
